...
stig/0.1.8-0 darwin-x64 node-v10.7.0
$ stig --help [COMMAND]
USAGE
  $ stig COMMAND
...
...
_See code: [src/commands/ls.js](https://github.com/defionscode/stig-cli/blob/v0.1.8-0/src/commands/ls.js)_
...
_See code: [src/commands/read.js](https://github.com/defionscode/stig-cli/blob/v0.1.8-0/src/commands/read.js)_
